                    ...
                    <ul class="nav navbar-nav navbar-right">
                       <li class="dropdown">
                            ...
                            <ul class="dropdown-menu multi-level" role="menu" aria-labelledby="dropdownMenu">
                                ...
                                <li class="dropdown-submenu">
                                    <a tabindex="-1" href="#">Themes (8+)  <span class="label new-label">New</span></a>
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a href="../e-commerce/index.html" target="_blank">E-commerce <span class="label new-label">New</span></a></li>
                                        <li><a href="../assan-blog/index.html" target="_blank">Blog Template <span class="label new-label">New</span></a></li>
                                        ...
                                        <li><a href="../app-landing/index.html" target="_blank">App landing - I-phone <span class="label new-label">New</span></a></li>
                                        <li><a href="../app-landing/index-android.html" target="_blank">App landing - Android <span class="label new-label">New</span></a></li>
                                    </ul>
                                </li>
